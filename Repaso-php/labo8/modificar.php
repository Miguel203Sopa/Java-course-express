...
placeholder="ISBN" class="large" /> <span class="iconplace"></span> </div>
 </div>
 <div class="element-name form-group"> <label
class="title"></label>
 <div class="nameFirst"> <input class="formcontrol" type="text" name="autor" value="<?php echo $row['autor']
?>" maxlength="50" placeholder="Autor" class="large" /> <span
class="icon-place"></span> </div>
 </div>
 <div class="element-input form-group"> <label
class="title"></label>
 <div class="item-cont"> <input class="formcontrol" type="text" name="titulo" value="<?php echo
...
class="title"></label>
 <div class="item-cont"> <input class="formcontrol" type="text" name="precio" value="<?php echo
...
/> </div> </li> </ul> </fieldset> </form> -->
 ...
 <a href="mostrarlibros.php?opc=modificar" class="dblock h3 font-weight-normal">Volver<br>
