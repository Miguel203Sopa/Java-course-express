...
<head>
 <meta charset="utf-8" />
 <!-- Indicar al navegador que el sitio estará optimizado para dispositivos
móviles -->
...
href="http://fonts.googleapis.com/icon?family=Material+Icons" /> -->
 ...
 <link rel="stylesheet"
href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/css/materialize.mi
n.css" />
...
if(isset($_POST['btnContar'])):
 ...
 echo "<p>Se han contabilizado: " . count($textolimpio) . " $complemento</p>\n";
    ...
    ?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" name="frmtexto"
id="frmtexto" class="col s12">
...
s12"></textarea>
 ...
 <div class="12u">
 <button type="submit" name="btnContar" id="btnContar" class="btn waveseffect waves-light">
...
<script
src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/js/materialize.min.
js"></script>
</html>
