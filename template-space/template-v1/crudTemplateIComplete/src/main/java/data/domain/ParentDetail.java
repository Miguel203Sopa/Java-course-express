...
public class ParentDetail {
    ...
    public ParentDetail( Long Id, String Name, Long Quantity, Parent idParent, Long createdBy, LocalDate createdAt, Long updatedBy, LocalDate updatedAt, Boolean enabled) {
        this.setId(Id);
        this.setName(Name);
